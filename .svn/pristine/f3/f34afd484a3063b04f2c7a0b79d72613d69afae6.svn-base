					...
					<Card class="ableDrag">
						...
						<Menu style="width: 90%;margin: 0 auto;">
			                ...
			                <Submenu name="3">
			                    ...
			                    <Menu-item id="buttondrag" name="2-1" style="min-height: 60px; position: relative; padding: 10px;">
		        			...
		        			<Row>
		        				...
		        				<Col span="17" offset="1">
		        					<Select v-model="viewpageid" style="width:200px;margin-bottom: 15px;">
								        <Option v-for="item in tablePageList" :label="item.pagename" :value="item.pageid" :key="item.pageid"></Option>
								    </Select>
		        				</Col>
		        			</Row>
		        			<Row>
			        			...
			        			<Row>
			        				...
			        				<Col span="14">
			        					<Select v-model="showonmodal.filtervaluebychoose" style="width:200px;margin-bottom: 15px;">
									        <Option v-for="item in systemsks" :label="item.value" :value="item.key" :key="item.key"></Option>
									    </Select>
			        				</Col>
			        			</Row>
			        		</div>
	        		...
	        		<Row>
	        			...
	        			<Col span="15" offset="1">
	        				<Select v-model="setLabelForm.fontStyle.textAlign" style="width:200px">
						        <Option v-for="item in textAligns" :value="item.value" :label="item.value" :key="item.value"></Option>
						    </Select>
	        			</Col>
	        		</Row>
	        	</Form-item>
	        		...
	        		<Row>
	        			...
	        			<Col span="15" offset="1">
	        				 <Select v-model="setstronglistForm.from" style="width:200px">
						        <Option v-for="item in listheads" :value="item.key" :label="item.title" :key="item.key"></Option>
						    </Select>
	        			</Col>
	        		</Row>
	        	</Form-item>
    ...
    export default {
        ...
        methods: {
            ...
            newcountchildflowidchange(){
            	...
            	console.log("新增统计列选择子流程")
            	console.log(allsks)
            	console.log(this.newcountcolumndata)
            },
         	selectSkOrCk(){
         		this.isCk = !this.isCk
			...
			setPageContentBySkid(id,str){
				for(var i=0;i< this.querySkids.length;i++){
					if(id == this.querySkids[i].id){
						if(this.noAreaIndex != "" && (this.colIndex == "" || this.colIndex == undefined)){
							console.log(342)
							console.log(this.querySkids[i].id)
							console.log(pagecontent[this.colIndex])
							pagecontent[this.noAreaIndex ].openSk = this.querySkids[i].id
						}else if((this.noAreaIndex == "" || this.noAreaIndex == undefined) && this.colIndex !=""){
							console.log(555)
							console.log(this.querySkids[i].id)
							console.log(pagecontent[this.colIndex].child[this.colButtonIndex])
