              ...
              <Form ref="reverseConditionModalForm">
                  ...
                  <Form-item label="请选择消息详情页面" :label-width="100">
                    <Select v-model="detailPage" placeholder="请选择消息详情页面">
                      <Option v-for="(item,index) in curFlowPageList" :value="item.value" :key="index">
                        {{ item.label }}
                      </Option>
                    </Select>
                  </Form-item>
    ...
    export default {
            ...
            conditionid(){
                ...
                if(this.conditionid == "empty"){
                    ...
                    if(_conditionInfo.page){
                        this.detailPage = _conditionInfo.nodeid + '|' + _conditionInfo.page;
                    }
        ...
        methods:{
            ...
            ReverseConditionModalOk(){
                var _pageandnodeid = this.detailPage;
