	        ...
	        <Row>
	        	<Col span="12" offset="1">
			        ...
			        <div style="padding: 20px 0;">
		        		...
		        		<Row>
		        			...
		        			<Col span="15" offset="1">
		        				 <Select v-model="showonmodal.nodeid" :clearable=true style="width:200px" @on-change="changetablenodeid(showonmodal.nodeid)">
	        	...
	        	<Col span="10" offset="1">
		        		...
		        		<div>
		        			...
		        			<div v-show="isEditBtn">
								...
								<Row>
			        				...
			        				<Col span="17" offset="1">
			        					<Select v-model="showonmodal.editBtnFunction" style="width:200px;margin-bottom: 15px;">
									        <Option v-for="item in editBtnFunctions" :value="item.key" :label="item.value" :key="item.key"></Option>
									    </Select>
			        				</Col>
			        			</Row>
			        			<Row>
	        		...
	        		<div style="border: 1px dashed #ddd;padding: 5px;margin-bottom: 15px;">
						...
						<div v-show="showonmodal.isapprovalstatus">
		        			<Row>
		        				<Col span="7" style="font-size: 14px;line-height: 30px;">
		        					设置审批条件：
		        				</Col>
		        				<Col span="16" offset="1">
										<Select v-model="showonmodal.approvalconditions" :clearable=true style="width:200px;margin-bottom: 15px;">
										        <Option v-for="item in systemsksapproval" :value="item.key" :label="item.value" :key="item.key"></Option>
									    </Select>
		        				</Col>
		        			</Row>
		        		</div>
	        		...
	        		<div style="border: 1px dashed #ddd;padding: 5px;margin-bottom: 15px;">
	        			<div>
	        				<Checkbox v-model="showonmodal.subpersonismyself" style="padding-bottom: 15px;">设置提交人为我自己</Checkbox>
	        			</div>
						<div>
	        				<Checkbox v-model="showonmodal.appropersonmyself" style="padding-bottom: 15px;">设置审批人为我自己</Checkbox>
	        			</div>
	        		</div>
	        		<!--是否只显示子数据-->
	        		<div style="border: 1px dashed #ddd;padding: 5px;margin-bottom: 15px;">
	        			...
	        			<div v-show="showonmodal.isfilterBtn">
			        		...
			        		<div v-show="showonmodal.filterchoosesystemsk">
			        			<Row>
									...
									<Col span="9" style="font-size: 14px;line-height: 30px;" v-show="showonmodal.filtervaluebychoose=='system-myitemid'">
										主列表过滤列
			        				</Col>
			        				<Col span="14" v-show="showonmodal.filtervaluebychoose=='system-myitemid'">
			        					<Input placeholder="请输入..." v-model="showonmodal.parentcolname"></Input>
			        				</Col>
			        			</Row>
			        		</div>
			        		<div v-show="!showonmodal.filterchoosesystemsk">
...
<script>
	...
	let componentsContent = [
		...
		},
		{
			...
			name:"laborfinancialofficer",
			start:'<img width="100%" src="',
			openstart:'" alt="',
			end:'"/>'
		},{
			name:"laborfinancialandtax",
			start:'<img width="100%" src="',
			openstart:'" alt="',
			end:'"/>'
		},{
			...
			name:"projectapprovaloffice",
			start:'<img width="100%" src="',
			openstart:'" alt="',
			end:'"/>'
		},{
			name:"projectapprovalcaiwu",
			start:'<img width="100%" src="',
			openstart:'" alt="',
			end:'"/>'
		},{
			name:"projectapprovalse",
			start:'<img width="100%" src="',
			openstart:'" alt="',
			end:'"/>'
		},{
			name:"projectapprovalheader",
			start:'<img width="100%" src="',
			openstart:'" alt="',
			end:'"/>'
		},{
			name:"projectapprovalover",
			start:'<img width="100%" src="',
			openstart:'" alt="',
			end:'"/>'
		},
        ...
        data () {
            return {
            	...
            	showonmodal:{
	            	...
	            	//新增统计列
	            	newcountcolumns:[],
					subpersonismyself:false,
					appropersonmyself:false,
					editBtnFunction : "update"
            	},
            	isViewBtn:false,
            	isEditBtn:false,
            	viewpageid:'',
            	...
            	dummyComponents:[
					...
					{
						src:'../../images/srfinance.png',
            			value:'科研-财务',
            			id:181,
            			elType:'srfinance'
					},
					{
						src:'../../images/sragent.png',
            			value:'科研-经办人',
            			id:182,
            			elType:'sragent'
					},
					{
						src:'../../images/srheader.png',
            			value:'科研-课题负责人',
            			id:183,
            			elType:'srheader'
					},
					{
						src:'../../images/srleader.png',
            			value:'科研-领导',
            			id:184,
            			elType:'srleader'
					},
					{
						src:'../../images/srsuoban.png',
            			value:'科研-所办',
            			id:185,
            			elType:'srsuoban'
					},
					{
						src:'../../images/srover.png',
            			value:'科研-完成',
            			id:186,
            			elType:'srover'
					},
					...
					{
						src:'../../images/laborfinancialofficer.png',
            			value:'劳务-财务负责人',
            			id:188,
            			elType:'laborfinancialofficer'
					},
					{
						src:'../../images/laborfinancialandtax.png',
            			value:'劳务-财务计税',
            			id:189,
            			elType:'laborfinancialandtax'
					},
					{
						src:'../../images/laboragent.png',
            			value:'劳务-经办人',
            			id:1810,
            			elType:'laboragent'
					},
					{
						src:'../../images/laborheader.png',
            			value:'劳务-课题负责人',
            			id:1811,
            			elType:'laborheader'
					},
					{
						src:'../../images/laborleader.png',
            			value:'劳务-领导',
            			id:1812,
            			elType:'laborleader'
					},{
						src:'../../images/laborover.png',
            			value:'劳务-完成',
            			id:1813,
            			elType:'laborover'
					},{
						src:'../../images/projectapprovaloffice.png',
            			value:'立项-办公室',
            			id:1814,
            			elType:'projectapprovaloffice'
					},{
						src:'../../images/projectapprovalcaiwu.png',
            			value:'立项-财务',
            			id:1815,
            			elType:'projectapprovalcaiwu'
					},{
						src:'../../images/projectapprovalse.png',
            			value:'立项-科教处',
            			id:1816,
            			elType:'projectapprovalse'
					},{
						src:'../../images/projectapprovalheader.png',
            			value:'立项-课题负责人',
            			id:1817,
            			elType:'projectapprovalheader'
					},{
						src:'../../images/projectapproval.png',
            			value:'立项-完成',
            			id:1818,
            			elType:'projectapproval'
					},
            		{
        ...
        methods: {
        	...
        	messagecardtypechange(){},
          	...
          	changetablenodeid(id){
				var me = this;
          		me.tablePageList = [];
				var tempnodelist = me.nodeList;
          		for(let i=0,len = tempnodelist.length;i<len;i++){
					let temppagelist =  tempnodelist[i].pageList;
					for(let j=0;j<temppagelist.length;j++){
						tempnodelist[i].pageList[j].pagename += "(" + tempnodelist[i].nodeid + ")";
						me.tablePageList.push(tempnodelist[i].pageList[j]);
					}
         		}
          	},
         	//
         	...
         	setmycardOk(){
         		var title = this.mycardForm.cardTitle;
				var open = this.mycardForm.pageid
				if(this.noAreaIndex != "" && (this.colIndex == "" || this.colIndex == undefined)){
					pagecontent[this.noAreaIndex].value = title
					pagecontent[this.noAreaIndex].open = open
					console.log(pagecontent);

				}else if((this.noAreaIndex == "" || this.noAreaIndex == undefined) && this.colIndex !=""){
					pagecontent[this.colIndex].child[this.colButtonIndex].open = open
					pagecontent[this.colIndex].child[this.colButtonIndex].value = title
					console.log(pagecontent);
				}
				this.noAreaIndex = ''
				this.colIndex = ''
            ...
            setTable(){
				...
				if(this.showonmodal.approvalconditions == "全部"){
					this.showonmodal.approvalconditions = "";
				}
				if(this.showonmodal.nodeid == "全部"){
					this.showonmodal.nodeid = "";
				}
				if(this.showonmodal.parentcolname){  //把转换成拼音
					this.showonmodal.parentcolname = this.getPinyin(this.showonmodal.parentcolname);
				}
            	if(this.noAreaIndex != "" && (this.colIndex == "" || this.colIndex == undefined)){
					pagecontent[this.noAreaIndex ].value = value
					pagecontent[this.noAreaIndex ].open = open
				...
				this.showonmodal.parentcolname = ""
            },
            cancelTable(){},
            filterkeyisstatus(){
            	var arr1 = [
			...
			drop(event){
				...
				if(/myButton/.test(dragDomClass)){
					...
					elType = "HisToGram"
				}else if(/homePage/.test(dragDomClass)){
					elType = "homePage"
				}else if(/srfinance/.test(dragDomClass)){
					elType = "srfinance"
				}else if(/sragent/.test(dragDomClass)){
					elType = "sragent"
				}else if(/srheader/.test(dragDomClass)){
					elType = "srheader"
				}else if(/srleader/.test(dragDomClass)){
					elType = "srleader"
				}else if(/srsuoban/.test(dragDomClass)){
					elType = "srsuoban"
				}else if(/srover/.test(dragDomClass)){
					elType = "srover"
				}else if(/labor/.test(dragDomClass)){
					elType = "labor"
				}else if(/laborfinancialofficer/.test(dragDomClass)){
					elType = "laborfinancialofficer"
				}else if(/laborfinancialandtax/.test(dragDomClass)){
					elType = "laborfinancialandtax"
				}else if(/laboragent/.test(dragDomClass)){
					elType = "laboragent"
				}else if(/laborheader/.test(dragDomClass)){
					elType = "laborheader"
				}else if(/laborleader/.test(dragDomClass)){
					elType = "laborleader"
				}else if(/laborover/.test(dragDomClass)){
					elType = "laborover"
				}else if(/projectapprovaloffice/.test(dragDomClass)){
					elType = "projectapprovaloffice"
				}else if(/projectapprovalcaiwu/.test(dragDomClass)){
					elType = "projectapprovalcaiwu"
				}else if(/projectapprovalse/.test(dragDomClass)){
					elType = "projectapprovalse"
				}else if(/projectapprovalheader/.test(dragDomClass)){
					elType = "projectapprovalheader"
				}else if(/projectapprovalover/.test(dragDomClass)){
					elType = "projectapprovalover"
				...
				for(var i=0;i< this.queryCkids.length;i++){
					if(id == this.queryCkids[i].id){
						if(this.noAreaIndex != "" && (this.colIndex == "" || this.colIndex == undefined)){
							...
							pagecontent[this.colIndex].child[this.colButtonIndex].value = ""
						}
					}
				}
				//
							...
							for(var n=0, componentL = componentsContent.length;n < componentL ; n++){
								if(pagecontent[temp].child[k].elType == componentsContent[n].name){
									if(pagecontent[temp].child[k].elType == "myLabel"){
										...
										console.log(pagecontent[temp].child[k].value);
