...
<template>
    <section>
        ...
        <Modal
	        ...
	        <div id="editpagetobeadd"><tijiaobiaodan></tijiaobiaodan></div>
			<div slot="footer"></div>
        </Modal>
    </section>
</template>
...
import tijiaobiaodan from '../../5a140e4ce6134880181775b7/kaishi/tijiaobiaodan.vue';
	...
	let pageviewid = ""
	let pageeditid = "5a140ec9e6134880181775b9"
	...
	let showmodal = {"viewinmodal":false,"editinmodal":false,"editbtnname":"","viewbtnname":"","iscountBtn":false,"isfilterBtn":false,"isshowflowdata":true,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"isonlyshowchilddata":false,"flowid":"5a140e4ce6134880181775b7","nodeid":"","newcountcolumns":[],"subpersonismyself":true,"appropersonmyself":false}
    export default {
    	components:{
tijiaobiaodan,
},
