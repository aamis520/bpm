...
<script>
	...
	let setnew = [{"title":"开始时间","key":"kaishishijian"},{"title":"结束时间","key":"jieshushijian"}];

	let tableData = []
	let childtableData = []

	let showmodal = {"viewinmodal":false,"editinmodal":false,"editbtnname":"","viewbtnname":"","iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"isonlyshowchilddata":false,"flowid":"5a141043e6134880181775c1","nodeid":"ziliucheng","newcountcolumns":[],"subpersonismyself":false,"appropersonmyself":false}
    export default {
    	components:{},
        data () {
            return {
