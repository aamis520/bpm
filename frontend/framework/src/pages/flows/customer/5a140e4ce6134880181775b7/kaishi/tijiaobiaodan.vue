...
<template>
    ...
    <div class="tabform">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="24"><Form-item v-show="showformInline.xingming" prop="xingming" label="姓名"><i-input :disabled="disabledformInline.xingming" v-model.trim="formInline.xingming" placeholder="请输入..."></i-input></Form-item>
</Col></Row><Row><Col span="24"><Form-item v-show="showformInline.shouru" prop="shouru" label="收入"><i-input :disabled="disabledformInline.shouru" v-model.trim="formInline.shouru" placeholder="请输入..."></i-input></Form-item>
</Col></Row><Row><Col span="24"><RmyCard99800138></RmyCard99800138></Col></Row></div>
...
<script>
	...
	let importstart;
 import RmyCard99800138 from '../../5a140e4ce6134880181775b7/kaishi/myCard99800138.vue'
	let selectwords=[];//下拉框
	...
	let ownpageid = "5a140ec9e6134880181775b9"
	let newitemid = null
    ...
    export default {
    	components:{
RmyCard99800138,VueEditor,selectOnePersonModal},
        data() {
            return {
            	//人员选择相关
            	choosepersonkey:'',
...
//    			delCookie("parent")
    ...
    function generateDataIfShowmodel () {
            var itemshow = {"xingming":"","shouru":"","submitbtn":"","backbtn":""};
