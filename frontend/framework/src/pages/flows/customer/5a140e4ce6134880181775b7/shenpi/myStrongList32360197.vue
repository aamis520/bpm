...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><tijiaobiaodan></tijiaobiaodan></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
...
<script>
	let importstart;
import tijiaobiaodan from '../../5a140e4ce6134880181775b7/kaishi/tijiaobiaodan.vue';


	let ownflowid = "5a140e4ce6134880181775b7"
	let ownnodeid = "shenpi"
	let ownpageid = "5a153e9d91b04a9c63f4b642"

	let pageviewid = "5a140ec9e6134880181775b9"
	let pageeditid = ""
	let setnew = [{"title":"姓名","key":"xingming"},{"title":"收入","key":"shouru"}];
	let search = [{"label":"伪屌丝","from":"xingming"},{"label":"轻微的","from":"shouru"},{"label":"挖到所","from":"shouru"},{"label":"毒瓦","from":"shouru"}];
	let tableData = []
	let childtableData = []

	let showmodal = {"viewinmodal":false,"editinmodal":false,"editbtnname":"","viewbtnname":"查看","iscountBtn":false,"isfilterBtn":false,"isshowflowdata":true,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"isonlyshowchilddata":false,"flowid":"5a140e4ce6134880181775b7","nodeid":"","newcountcolumns":[],"subpersonismyself":false,"appropersonmyself":false}
...
tijiaobiaodan,
        ...
        methods:{
        	handleQuery() {
		        ...
		        showmodal.isapprovalstatus = false
