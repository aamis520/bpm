...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><shenpia></shenpia></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
...
<script>
	let importstart;
import shenpia from '../../5a138f19d818b768265cd6df/approval/shenpia.vue';


	let ownflowid = "5a138f19d818b768265cd6df"
	let ownnodeid = "approval"
	let ownpageid = "5a16482772c81ad02bd72768"

	let pageviewid = "5a16481672c81ad02bd72767"
	let pageeditid = ""
	...
	let showmodal = {"viewinmodal":true,"editinmodal":false,"editbtnname":"","viewbtnname":"","iscountBtn":false,"isfilterBtn":false,"isshowflowdata":true,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":true,"isonlyshowchilddata":false,"flowid":"5a138f19d818b768265cd6df","nodeid":"approval","newcountcolumns":[],"subpersonismyself":false,"appropersonmyself":false,"approvalconditions":"system-approve"}
    export default {
    	components:{
shenpia,
},
        ...
        methods:{
        	handleQuery() {
				...
				this.$Message.success('11111111111111111111111111');
		        if(isapprovalstatus){
