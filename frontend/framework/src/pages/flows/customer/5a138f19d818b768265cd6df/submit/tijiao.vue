...
<template>
    ...
    <div class="tabform">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="6"><Form-item v-show="showformInline.zihangche" prop="zihangche" label="自行车"><i-input :disabled="disabledformInline.zihangche" v-model.trim="formInline.zihangche" placeholder="请输入..."></i-input></Form-item>
</Col><Col span="6">&nbsp;</Col><Col span="6">&nbsp;</Col><Col span="6">&nbsp;</Col></Row><Row><Col span="6"><Form-item v-show="showformInline.zhouxingchi" prop="zhouxingchi" label="周星驰"><i-input :disabled="disabledformInline.zhouxingchi" v-model.trim="formInline.zhouxingchi" placeholder="请输入..."></i-input></Form-item>
</Col><Col span="6">&nbsp;</Col><Col span="6">&nbsp;</Col><Col span="6">&nbsp;</Col></Row></div>
...
<script>
	...
	let ownpageid = "5a16362b72c81ad02bd72762"
	let newitemid = null
...
//    			delCookie("parent")
    ...
    function generateDatamodel () {
            var item = {"zihangche":"","zhouxingchi":""};
            return item;
    }
    ...
    function generateDataIfShowmodel () {
            var itemshow = {"zihangche":"","zhouxingchi":"","submitbtn":"","backbtn":""};
