...
<script>
	...
	let ownnodeid = "tongji"
	let ownpageid = "5a167d2c334df23004cf5ed6"
	...
	let showmodal = {"viewinmodal":false,"editinmodal":false,"editbtnname":"","viewbtnname":"","iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"isonlyshowchilddata":false,"flowid":"5a138f19d818b768265cd6df","nodeid":"","newcountcolumns":[{"title":"自行车v","key":"zihangchev","isuse":true,"from":"column","own":{"flowid":"5a138f19d818b768265cd6df","columns":[]},"column":{"flowid":"5a138f19d818b768265cd6df","columns":[{"key":"zihangche","calculation":"+"},{"key":"zhouxingchi","calculation":"+"}]},"relate":{"flowid":"5a138f19d818b768265cd6df","childflowid":"","maintagkey":"","childtagkey":"","columns":[]}}],"subpersonismyself":false,"appropersonmyself":false}
    export default {
    	components:{},
        data () {
            return {
						...
						if(lnccl !=0){
							for(var e=0;e<lnccl;e++){
								...
								if(newcountcolumns[temp].isuse == "true" || newcountcolumns[temp].isuse == true) {
									console.log("qwerdf");
									console.log(newcountcolumns[temp]);
