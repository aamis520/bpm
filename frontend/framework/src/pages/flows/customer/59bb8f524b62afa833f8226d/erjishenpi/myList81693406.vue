...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><erjishenpixiangqing></erjishenpixiangqing></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
...
<script>
	let importstart;
import erjishenpixiangqing from '../../59bb8f524b62afa833f8226d/erjishenpi/erjishenpixiangqing.vue';

	
	let ownflowid = "59bb8f524b62afa833f8226d"
	let ownnodeid = "erjishenpi"
	let ownpageid = "59bb958d1f89f89428c10b2e"
	
	let pageviewid = "59bb95cb1f89f89428c10b2f"
	let pageeditid = ""
	...
	let showmodal = {"viewinmodal":false,"editinmodal":false,"iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"flowid":"59bb8f524b62afa833f8226d","nodeid":"erjishenpi","newcountcolumns":[]}
    export default {
    	components:{
erjishenpixiangqing,
},
