...
<script>
	...
	let pageviewid = ""
	let pageeditid = ""
	let setnew = [{"title":"申请人","key":"shenqingren"},{"title":"支出申请","key":"zhichushenqing"},{"title":"申请时间","key":"shenqingshijian"},{"title":"支出理由","key":"zhichuliyou"}];
	
	let tableData = null
	
	let showmodal = {"viewinmodal":false,"editinmodal":false,"iscountBtn":false,"isfilterBtn":true,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"shenqingren","filtervaluebychoose":"system-myself","filtervaluebyfill":"","filterchoosesystemsk":true}
    export default {
    	components:{},
        data () {
            return {
