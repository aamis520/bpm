...
<template>
    ...
    <div class="tabform">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="12"><Form-item label="申请人"><i-input v-model.trim="formInline.shenqingren" placeholder="请输入..."></i-input></Form-item>
</Col><Col span="12"><Form-item label="支出申请"><i-input v-model.trim="formInline.zhichushenqing" placeholder="请输入..."></i-input></Form-item>
</Col></Row><Row><Col span="12"><Form-item label="申请时间"><Date-picker type="date" placeholder="选择日期" format="yyyy年MM月dd日" v-model:value="formInline.shenqingshijian" ></Date-picker></Form-item>
</Col><Col span="12"><Form-item label="支出理由"><i-input v-model.trim="formInline.zhichuliyou" placeholder="请输入..."></i-input></Form-item>
</Col></Row><RmyList54761833></RmyList54761833></div>
...
<script>
	let importstart;
 import RmyList54761833 from '../../59a4d8e174f130944caa22fa/tijiaobiaodan/myList54761833.vue'
...
RmyList54761833,},
    ...
    function generateDatamodel () {
            var item = {"shenqingren":" ","zhichushenqing":" ","zhichuliyou":" "};
            return item;
    }
