...
<Form-item label="上班时间"><i-input v-model.trim="formInline.shangbanshijian" placeholder="请输入..."></i-input></Form-item>
<Form-item label="下班时间"><i-input v-model.trim="formInline.xiabanshijian" placeholder="请输入..."></i-input></Form-item>
...
<script>
	...
	let ownpageid = "598ad1b269f35ab841e4d381"
    ...
    function generateDatamodel () {
            var item = {"xingming":" ","shouru":" ","shangbanshijian":" ","xiabanshijian":" ","zhichu":" "};
            return item;
    }
