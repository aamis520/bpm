...
<script>
	let importstart;
import shenpixiangqing from '../../59a7ccfeccfd23f457742680/shenpi/shenpixiangqing.vue';

	
	let ownflowid = "59a7ccfeccfd23f457742680"
	let ownnodeid = "shenpi"
	let ownpageid = "59a7cfc0f93d47405ee0b49d"
	
	let pageviewid = "59a7cf94f93d47405ee0b49c"
	let pageeditid = ""
	let setnew = [{"title":"收入","key":"shouru"}];
	
	let tableData = null
	
	let showmodal = {"viewinmodal":false,"editinmodal":false,"iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"flowid":"59a7ccfeccfd23f457742680","nodeid":"shenpi"}
    export default {
    	components:{
shenpixiangqing,
},
