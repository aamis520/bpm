...
<template>
    ...
    <div class="form">
        ...
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="24"><RmyList18220574></RmyList18220574></Col></Row></div>
...
<script> 
	let importstart;
 import RmyList18220574 from '../../59a7ccfeccfd23f457742680/shenpi/myList18220574.vue'
