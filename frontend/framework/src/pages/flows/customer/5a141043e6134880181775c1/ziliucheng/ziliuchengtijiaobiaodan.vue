...
<template>
    ...
    <div class="tabform">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="12"><Form-item v-show="showformInline.kaishishijian" prop="kaishishijian" label="开始时间"><i-input :disabled="disabledformInline.kaishishijian" v-model.trim="formInline.kaishishijian" placeholder="请输入..."></i-input></Form-item>
</Col><Col span="12"><Form-item v-show="showformInline.jieshushijian" prop="jieshushijian" label="结束时间"><i-input :disabled="disabledformInline.jieshushijian" v-model.trim="formInline.jieshushijian" placeholder="请输入..."></i-input></Form-item>
</Col></Row></div>
...
<script>
	...
	let ownflowid = "5a141043e6134880181775c1"
	let ownnodeid = "ziliucheng"
	let ownpageid = "5a1410bae6134880181775c3"
	let newitemid = null
	let pagefromview = false  //是否为查看按钮跳转过来的
	let flowdatas = []//所有下拉框数据的集合
	let parentid = ""
	let showchilddata=true;//表单基础设置的选择
...
//    			delCookie("parent")
    ...
    function generateDatamodel () {
            var item = {"kaishishijian":"","jieshushijian":""};
            return item;
    }
    ...
    function generateDataIfShowmodel () {
            var itemshow = {"kaishishijian":"","jieshushijian":"","submitbtn":"","backbtn":""};
