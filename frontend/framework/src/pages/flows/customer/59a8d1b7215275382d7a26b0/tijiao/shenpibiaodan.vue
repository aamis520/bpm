...
<template>
    ...
    <div class="tabform">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="24"><Form-item v-show="showformInline.tijiaobiaodan" prop="tijiaobiaodan" label="提交表单"><i-input :disabled="disabledformInline.tijiaobiaodan" v-model.trim="formInline.tijiaobiaodan" placeholder="请输入..."></i-input></Form-item>
</Col></Row></div>
...
<script>
	...
	let ownflowid = "59a8d1b7215275382d7a26b0"
	let ownnodeid = "tijiao"
	let ownpageid = "59a8d24d215275382d7a26b2"
	let newitemid = null
...
//    			delCookie("parent")
    ...
    function generateDataIfShowmodel () {
            var itemshow = {"tijiaobiaodan":"","submitbtn":"","backbtn":""};
