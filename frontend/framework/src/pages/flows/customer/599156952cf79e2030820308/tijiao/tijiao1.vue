...
<Form-item label="负责人"><i-input v-model.trim="formInline.fuzeren" placeholder="请输入..."></i-input></Form-item>
...
<script>
	...
	let ownpageid = "59915af02cf79e203082030b"
    ...
    function generateDatamodel () {
            var item = {"xiangmu":" ","fuzeren":" ","shouru":" ","zhichu":" ","shijian":" "};
            return item;
    }
