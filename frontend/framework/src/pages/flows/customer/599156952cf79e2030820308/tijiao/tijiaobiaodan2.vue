...
<template>
    ...
    <div class="form">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Form-item label="项目"><i-input v-model.trim="formInline.xiangmu" placeholder="请输入..."></i-input></Form-item>
<Form-item label="姓名"><i-input v-model.trim="formInline.xingming" placeholder="请输入..."></i-input></Form-item>
...
<Form-item label="提交时间"><i-input v-model.trim="formInline.tijiaoshijian" placeholder="请输入..."></i-input></Form-item>
</div>
...
<script>
	...
	let ownflowid = "599156952cf79e2030820308"
	let ownnodeid = "tijiao"
	let ownpageid = "5992a3def4e16c54271ca984"
    ...
    function generateDatamodel () {
            var item = {"xiangmu":" ","xingming":" ","shouru":" ","zhichu":" ","shiyou":" ","tijiaoshijian":" "};
            return item;
    }
