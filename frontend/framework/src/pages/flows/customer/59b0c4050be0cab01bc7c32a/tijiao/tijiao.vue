...
<template>
    ...
    <div class="tabform">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="24"><Form-item label="申请人"><i-input v-model.trim="formInline.shenqingren" disabled  placeholder="请输入..."></i-input></Form-item>
</Col></Row><Row><Col span="24"><Form-item label="申请金额"><i-input v-model.trim="formInline.shenqingjine" placeholder="请输入..."></i-input></Form-item>
...
</Col></Row><Row><Col span="24"><Form-item label="申请项目"><i-input v-model.trim="formInline.shenqingxiangmu" placeholder="请输入..."></i-input></Form-item>
</Col></Row></div>
...
<script>
	...
	let ownflowid = "59b0c4050be0cab01bc7c32a"
	let ownnodeid = "tijiao"
	let ownpageid = "59b0ee4c0be0cab01bc7c340"
    ...
    function generateDatamodel () {
            var item = {"shenqingren":" ","shenqingjine":" ","shenqingxiangmu":" "};
            return item;
    }
