...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><shenpi1></shenpi1></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
	        ...
	        <div id="editpagetobeadd"><normalEmpty></normalEmpty></div>
			<div slot="footer"></div>
        </Modal>
    </section>
</template>
<script>
	let importstart;
import normalEmpty from '../../599120d7a277a0f82795a143/yijishenpi/normalEmpty.vue';

import shenpi1 from '../../599120d7a277a0f82795a143/yijishenpi/shenpi1.vue';

	
	let ownflowid = "599120d7a277a0f82795a143"
	let ownnodeid = "yijishenpi"
	let ownpageid = "59913fa3abfe7b9820ddbbf0"
	
	let pageviewid = "59913ef8abfe7b9820ddbbed"
	let pageeditid = "59913f63abfe7b9820ddbbee"
	let setnew = [{"title":"姓名","key":"xingming"},{"title":"收入","key":"shouru"},{"title":"事由","key":"shiyou"}];
