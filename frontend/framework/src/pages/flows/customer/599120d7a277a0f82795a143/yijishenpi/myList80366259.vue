...
<template>
    <section>
        ...
        <Modal
	        ...
	        <div id="editpagetobeadd"><shenpixiangqing></shenpixiangqing></div>
			<div slot="footer"></div>
        </Modal>
    </section>
</template>
<script>
	let importstart;
import shenpixiangqing from '../../599120d7a277a0f82795a143/yijishenpi/shenpixiangqing.vue';



	let ownflowid = "599120d7a277a0f82795a143"
	let ownnodeid = "yijishenpi"
	let ownpageid = "59913bf51fe929800ab4cadb"

	let pageviewid = "59913c381fe929800ab4cadc"
	let pageeditid = "59913c381fe929800ab4cadc"
