...
<template>
    ...
    <div class="tabform">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="12"><Form-item v-show="showformInline.xingming" prop="xingming" label="姓名"><i-input :disabled="disabledformInline.xingming" v-model.trim="formInline.xingming" placeholder="请输入..."></i-input></Form-item>
</Col><Col span="12"><Form-item v-show="showformInline.xinghao" prop="xinghao" label="型号"><i-input :disabled="disabledformInline.xinghao" v-model.trim="formInline.xinghao" placeholder="请输入..."></i-input></Form-item>
</Col></Row></div>
...
<script>
	...
	let ownpageid = "5a1bc895bdcf99944a09eda5"
	let newitemid = null
...
//    			delCookie("parent")
    ...
    function generateDataIfShowmodel () {
            var itemshow = {"xingming":"","xinghao":"","submitbtn":"","backbtn":""};
