...
<template>
    <section>
        ...
        <Modal
	        ...
	        <div id="editpagetobeadd"><zitijiaobiaodan></zitijiaobiaodan></div>
			<div slot="footer"></div>
        </Modal>
    </section>
</template>
...
import zitijiaobiaodan from '../../5a1689c03d287b1826b6118d/kaishi/zitijiaobiaodan.vue';
	...
	let pageviewid = ""
	let pageeditid = "5a1bc9a0bdcf99944a09edaa"
	...
	let showmodal = {"viewinmodal":false,"editinmodal":false,"editbtnname":"","viewbtnname":"","iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"isonlyshowchilddata":false,"flowid":"5a1689c03d287b1826b6118d","nodeid":"","newcountcolumns":[],"subpersonismyself":false,"appropersonmyself":false}
    export default {
    	components:{
zitijiaobiaodan,
},
