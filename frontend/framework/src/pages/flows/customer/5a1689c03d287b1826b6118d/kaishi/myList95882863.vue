...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><zitijiaobiaodan></zitijiaobiaodan></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
...
<script>
	let importstart;
import zitijiaobiaodan from '../../5a1689c03d287b1826b6118d/kaishi/zitijiaobiaodan.vue';


	let ownflowid = "5a1689c03d287b1826b6118d"
	let ownnodeid = "kaishi"
	let ownpageid = "5a1bc937bdcf99944a09eda9"

	let pageviewid = "5a1bc9a0bdcf99944a09edaa"
	let pageeditid = ""
	const oldpageviewid = pageviewid
	const oldpageeditid = pageeditid
	let setnew = [{"title":"姓名","key":"xingming"},{"title":"型号","key":"xinghao"}];

	let tableData = []
	let childtableData = []

	let showmodal = {"viewinmodal":false,"editinmodal":false,"editbtnname":"","viewbtnname":"","iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"isonlyshowchilddata":false,"flowid":"5a1689c03d287b1826b6118d","nodeid":"kaishi","newcountcolumns":[],"subpersonismyself":false,"appropersonmyself":false}
    export default {
    	components:{
zitijiaobiaodan,
},
        ...
        watch:{
			...
			pageishowwinthinmodal(){
				...
				if(len > 0) {
					...
					if(showmodal.filterkey && showmodal.filtervaluebychoose == "system-myitemid"){
