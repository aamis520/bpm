...
<template>
    ...
    <div class="form">
        ...
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><RmyList94977067></RmyList94977067></div>
...
<script> 
	let importstart;
 import RmyList94977067 from '../../5989367a9a1bb2e404459c15/jiedian2/myList94977067.vue'
	
	let ownflowid = "5989367a9a1bb2e404459c15"
	let ownnodeid = "jiedian2"
	let ownpageid = "598abf4c812a9b8c114d587a"
