...
<template>
    ...
    <div class="tabform">
        ...
        <Form ref="formInline" :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="12"><Form-item v-show="showformInline.renyuanID" prop="renyuanID" label="人员ID"><i-input :disabled="disabledformInline.renyuanID" v-on:on-focus="showPersonSelectModalFn('renyuanID')" v-model.trim="formInline.renyuanID" placeholder="请输入..."></i-input></Form-item>
</Col><Col span="12"><Form-item v-show="showformInline.renyuanxingming" prop="renyuanxingming" label="人员姓名"><i-input :disabled="disabledformInline.renyuanxingming" v-model.trim="formInline.renyuanxingming" placeholder="请输入..."></i-input></Form-item>
</Col></Row></div>
...
<script>
	...
	let choosepersonsets=[{"eltype":"chooseperson","label":"人员ID","elabel":"renyuanID","live":1,"value":"","index":"0","issetInput":false,"setInputword":"","setInputflowid":"598183c1800320c0526ad6fa","choosepersonset":"{\"key\":\"renyuanID\",\"programs\":[{\"inputkey\":\"renyuanID\",\"personinfokey\":\"loginId\"},{\"inputkey\":\"renyuanxingming\",\"personinfokey\":\"personName\"}]}"}];//人员选择
	...
	let ownflowid = "598183c1800320c0526ad6fa"
	let ownnodeid = "try"
	let ownpageid = "5a09524fccbddba026e81605"
	let newitemid = null
	let pagefromview = false  //是否为查看按钮跳转过来的
	let flowdatas = []//所有下拉框数据的集合
	let parentid = ""
	let showchilddata=false;//表单基础设置的选择
	let zhubeiObj = {};   //用来存放联动的主被动关系
...
//    			delCookie("parent")
    ...
    function generateDatamodel () {
            var item = {"renyuanID":"","renyuanxingming":""};
            return item;
    }
    ...
    function generateDataIfShowmodel () {
            var itemshow = {"renyuanID":"","renyuanxingming":"","submitbtn":"","backbtn":""};
