...
<template>
    ...
    <div class="form">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Form-item label="支出"><i-input v-model.trim="formInline.zhichu" placeholder="请输入..."></i-input></Form-item>
...
<script>
	...
	let ownflowid = "599a82ef0e2eb5a03872b629"
	let ownnodeid = "tijiaoshuju"
	let ownpageid = "599a83170e2eb5a03872b62b"
