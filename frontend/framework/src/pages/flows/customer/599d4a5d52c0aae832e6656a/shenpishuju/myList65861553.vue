...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><xiangqing></xiangqing></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
...
<script>
	let importstart;
import xiangqing from '../../599d4a5d52c0aae832e6656a/shenpishuju/xiangqing.vue';
	...
	let pageviewid = "599d4dcdb7b51bc80dd4732f"
	let pageeditid = ""
