...
<template>
    ...
    <div class="form">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Form-item label="申请人"><i-input v-model.trim="formInline.shenqingren" placeholder="请输入..."></i-input></Form-item>
<Form-item label="项目"><i-input v-model.trim="formInline.xiangmu" placeholder="请输入..."></i-input></Form-item>
<Form-item label="申请金额"><i-input v-model.trim="formInline.shenqingjine" placeholder="请输入..."></i-input></Form-item>
<Form-item label="理由"><i-input v-model.trim="formInline.liyou" placeholder="请输入..."></i-input></Form-item>
</div>
...
<script>
	...
	let ownpageid = "599d4acd52c0aae832e6656c"
    ...
    function generateDatamodel () {
            var item = {"shenqingren":" ","xiangmu":" ","shenqingjine":" ","liyou":" "};
            return item;
    }
