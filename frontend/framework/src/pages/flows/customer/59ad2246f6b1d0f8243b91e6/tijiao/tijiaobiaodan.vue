...
<template>
    ...
    <div class="tabform">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="24"><Form-item label="提交数据"><i-input v-model.trim="formInline.tijiaoshuju" placeholder="请输入..."></i-input></Form-item>
</Col></Row></div>
...
<script>
	...
	let ownpageid = "59ad229ef6b1d0f8243b91e8"
