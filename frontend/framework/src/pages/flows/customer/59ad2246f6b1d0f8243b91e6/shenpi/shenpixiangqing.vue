...
<template>
    ...
    <div class="form">
        ...
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Col span="12"><RmyLabel83179559></RmyLabel83179559></Col></Row></div>
...
<script>
	let importstart;
 import RmyLabel83179559 from '../../59ad2246f6b1d0f8243b91e6/shenpi/myLabel83179559.vue'

	let ownflowid = "59ad2246f6b1d0f8243b91e6"
	let ownnodeid = "shenpi"
	let ownpageid = "59ad22d6f6b1d0f8243b91ea"
