...
<script>
	let importstart;
import shenpixiangqing from '../../59ad2246f6b1d0f8243b91e6/shenpi/shenpixiangqing.vue';


	let ownflowid = "59ad2246f6b1d0f8243b91e6"
	let ownnodeid = "shenpi"
	let ownpageid = "59ad2314f6b1d0f8243b91eb"

	let pageviewid = "59ad22d6f6b1d0f8243b91ea"
	let pageeditid = ""
	let setnew = [{"title":"提交数据","key":"tijiaoshuju"}];

	let tableData = null

	let showmodal = {"viewinmodal":false,"editinmodal":false,"iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"flowid":"59ad2246f6b1d0f8243b91e6","nodeid":"shenpi"}
    export default {
    	components:{
shenpixiangqing,
},
