...
<template>
    ...
    <div class="form">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Form-item label="负责人"><i-input v-model.trim="formInline.fuzeren" placeholder="请输入..."></i-input></Form-item>
<Form-item label="项目名称"><i-input v-model.trim="formInline.xiangmumingcheng" placeholder="请输入..."></i-input></Form-item>
...
<Form-item label="申请时间"><Date-picker type="date" placeholder="选择日期" format="yyyy年MM月dd日" v-model:value="formInline.shenqingshijian" ></Date-picker></Form-item>
</div>
...
<script>
	...
	let ownflowid = "5992a481e696e0480805d17e"
	let ownnodeid = "tijiaoshuju"
	let ownpageid = "5992a4ebe696e0480805d180"
    ...
    function generateDatamodel () {
            var item = {"fuzeren":" ","xiangmumingcheng":" ","zhichu":" ","shouru":" ","shiyou":" "};
            return item;
    }
