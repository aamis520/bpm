...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><shenpixiangqing2></shenpixiangqing2></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
...
<script>
	let importstart;
import shenpixiangqing2 from '../../59928f778a4a72140e78330d/shenpi/shenpixiangqing2.vue';

	
	let ownflowid = "59928f778a4a72140e78330d"
	let ownnodeid = "shenpi"
	let ownpageid = "599290898a4a72140e783313"
	
	let pageviewid = "599293879e8a735c1d7f9254"
	let pageeditid = ""
	let setnew = [{"title":"支出","key":"zhichu"}];
