...
<Form-item label="金额"><i-input v-model.trim="formInline.jine" placeholder="请输入..."></i-input></Form-item>
...
<script>
	...
	let ownflowid = "599d5b654b21614844886403"
	let ownnodeid = "tijiao"
	let ownpageid = "599d5bd44b21614844886405"
    ...
    function generateDatamodel () {
            var item = {"xingming":" ","jine":" ","xiangmu":" "};
            return item;
    }
