...
<template>
    ...
    <div class="tabform">
        <i-form ref:form-validate :model="formInline" :rules="ruleValidate" :label-width="80">
            <div id = "layouttobeadd"><Row><Col span="24"><Form-item label="提交"><i-input v-model.trim="formInline.tijiao" placeholder="请输入..."></i-input></Form-item>
</Col></Row></div>
...
<script>
	...
	let ownnodeid = "fasong"
	let ownpageid = "59ad266158c5971831356ae2"
