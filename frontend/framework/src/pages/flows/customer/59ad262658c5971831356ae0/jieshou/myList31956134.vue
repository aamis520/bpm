...
<template>
    <section>
	    ...
	    <Modal
	        ...
	        <div id="viewpagetobeadd"><jieshouxiangqing></jieshouxiangqing></div>
			<div slot="footer"></div>
        </Modal>
        <Modal
    		width = "1200"
...
<script>
	let importstart;
import jieshouxiangqing from '../../59ad262658c5971831356ae0/jieshou/jieshouxiangqing.vue';

	
	let ownflowid = "59ad262658c5971831356ae0"
	let ownnodeid = "jieshou"
	let ownpageid = "59ad26f258c5971831356ae5"
	
	let pageviewid = "59ad26b858c5971831356ae4"
	let pageeditid = ""
	let setnew = [{"title":"提交","key":"tijiao"}];
	
	let tableData = null
	
	let showmodal = {"viewinmodal":false,"editinmodal":false,"iscountBtn":false,"isfilterBtn":false,"isshowflowdata":false,"countTitle":"统计","countLabel":"tongji","filterColumn":"","countColumnStart":"","countColumnEnd":"","countColumnCalculation":"","filterkey":"","filtervaluebychoose":"","filtervaluebyfill":"","filterchoosesystemsk":false,"isdelbtn":false,"isapprovalstatus":false,"flowid":"59ad262658c5971831356ae0","nodeid":"jieshou"}
    export default {
    	components:{
jieshouxiangqing,
},
