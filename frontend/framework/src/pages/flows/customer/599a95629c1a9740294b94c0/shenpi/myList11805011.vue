...
<script>
	let importstart;
import shenpixiangqing from '../../599a95629c1a9740294b94c0/shenpi/shenpixiangqing.vue';

	
	let ownflowid = "599a95629c1a9740294b94c0"
	let ownnodeid = "shenpi"
	let ownpageid = "599f968222a6966016970220"
	
	let pageviewid = "599f961022a696601697021f"
	let pageeditid = ""
	let setnew = [{"title":"姓名","key":"xingming"},{"title":"年龄","key":"nianling"},{"title":"收入","key":"shouru"},{"title":"支出","key":"zhichu"}];
