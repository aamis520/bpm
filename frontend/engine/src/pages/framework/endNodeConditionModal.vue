            ...
            <Row>
              ...
              <Col span="16">
                ...
                <Select
                    ...
                    style="width:200px"
                    @on-change = "getSksAndNodeByFlowId(curFlowForm.toFlowID,'to')"
                >
          ...
          <Form-item>
            ...
            <Row>
              <Col span="11">
                ...
                <Select v-model="curFlowForm.tonodeid"
                  style="width:180px"
                >
                  <Option v-for="(ite,idx) in curFlowForm.toNodeList" :value="ite.value" :key="ite.value+idx+0">
                    {{ite.label}}
                  </Option>
                </Select>
              </Col>
              ...
              <Select v-model="curFlowForm.tonextnodeid"
                      style="width:190px"
              >
                <Option v-for="(itex,xidx) in curFlowForm.toNodeList" :value="itex.value" :key="itex.value+xidx+10">
                  {{itex.label}}
                </Option>
              </Select>
              </Col>
        ...
        <Form ref="relFlowForm1" v-model="relFlowForm1" :label-width=25>
          <Form-item>
            ...
            <Row>
              ...
              <Select v-model="relFlowForm1.tonodeid"
                      style="width:180px"
              >
                <Option v-for="(ite,idx) in relFlowForm1.toNodeList" :value="ite.value" :key="ite.value+idx+10">
                  {{ite.label}}
                </Option>
              </Select>
              </Col>
              ...
              <Select v-model="relFlowForm1.tonextnodeid"
                      style="width:190px"
              >
                <Option v-for="(itex,xidx) in relFlowForm1.toNodeList" :value="itex.value" :key="itex.value+xidx+10">
                  {{itex.label}}
                </Option>
              </Select>
              </Col>
          ...
          <Form-item class="mgb10">
            <Row>
              ...
              <Col span="16">
              <label class="mgr10">选择目标流程: </label>
              <Select v-model="relFlowForm1.curFlow.toFlowID"
                      @on-change = "getSksAndNodeByFlowId(relFlowForm1.curFlow.toFlowID,'to','cur')"
                      style="width:200px">
                <Option v-for="(item,idx) in flowList"
                        :value="item.value"
                        :key="item.value+idx+0"
          ...
          <Form-item class="mgb10">
            <Row>
              ...
              <Select v-model="relFlowForm1.relatedFlow.fromFlowID"
                      @on-change = "getSksAndNodeByFlowId(relFlowForm1.relatedFlow.fromFlowID,'from','rel')"
                      style="width:220px">
              ...
              <Select v-model="relFlowForm1.relatedFlow.toFlowID"
                      @on-change = "getSksAndNodeByFlowId(relFlowForm1.relatedFlow.toFlowID,'to','rel')"
                      style="width:220px">
                <Option v-for="(item,_idx) in flowList"
                        :value="item.value"
                        :key="item.value+_idx+1"
        ...
        <Form ref="relFlowForm2" v-model="relFlowForm2" :label-width=25>
          <Form-item>
            ...
            <Row>
              ...
              <Select v-model="relFlowForm2.tonodeid"
                      style="width:180px"
              >
                <Option v-for="(ite,idx) in relFlowForm2.toNodeList" :value="ite.value" :key="ite.value+idx+20">
                  {{ite.label}}
                </Option>
              </Select>
              </Col>
              ...
              <Select v-model="relFlowForm2.tonextnodeid"
                      style="width:190px"
              >
                <Option v-for="(itex,xidx) in relFlowForm2.toNodeList" :value="itex.value" :key="itex.value+xidx+20">
                  {{itex.label}}
                </Option>
              </Select>
              </Col>
          ...
          <Form-item class="mgb10">
            <Row>
              ...
              <Select v-model="relFlowForm2.curFlow.toFlowID"
                      @on-change = "getSksAndNodeByFlowId(relFlowForm2.curFlow.toFlowID,'to','cur')"
                      style="width:200px">
                <Option v-for="(item,idx) in flowList"
                        :value="item.value"
          ...
          <Form-item class="mgb10">
            <Row>
              ...
              <Select v-model="relFlowForm2.relatedFlow.fromFlowID"
                      @on-change = "getSksAndNodeByFlowId(relFlowForm2.relatedFlow.fromFlowID,'from','rel')"
                      style="width:220px">
                <Option v-for="(item,_idx) in flowList"
                        :value="item.value"
              ...
              <Select v-model="relFlowForm2.relatedFlow.toFlowID"
                      @on-change = "getSksAndNodeByFlowId(relFlowForm2.relatedFlow.toFlowID,'to','rel')"
                      style="width:220px">
                <Option v-for="(item,_idx) in flowList"
                        :value="item.value"
                        :key="item.value+_idx+2"
          ...
          >
            <Row>
              <Col span="7">
              <Select v-model="eachRelatedFlowsCondition.fromSkName" placement="top">
                <Option v-for="(item,_index) in relFlowForm2.relatedFlow.fromSkList" :value="item.value" :key="item.value+_index+2">
                  {{ item.label }}
                </Option>
              </Select>
              </Col>
              ...
              <Col span="7" offset="1">
              <Select v-model="eachRelatedFlowsCondition.toSkName" placement="top">
                <Option v-for="(item,_inde) in relFlowForm2.relatedFlow.toSkList" :value="item.value" :key="item.value+_inde+21">
                  {{ item.label }}
                </Option>
              </Select>
              </Col>
      ...
      <Form ref="relFlowForm3" v-model="relFlowForm3" :label-width=25>
        <Form-item>
          ...
          <Row>
            ...
            <Select v-model="relFlowForm3.tonodeid"
                    style="width:180px"
            >
              <Option v-for="(ite,idx) in relFlowForm3.toNodeList" :value="ite.value" :key="ite.value+idx+30">
                {{ite.label}}
              </Option>
            </Select>
            </Col>
            ...
            <Select v-model="relFlowForm3.tonextnodeid"
                    style="width:190px"
            >
              <Option v-for="(itex,xidx) in relFlowForm3.toNodeList" :value="itex.value" :key="itex.value+xidx+30">
                {{itex.label}}
              </Option>
            </Select>
            </Col>
        ...
        <Form-item class="mgb10">
          <Row>
            ...
            <Select v-model="relFlowForm3.curFlow.toFlowID"
                    @on-change = "getSksAndNodeByFlowId(relFlowForm3.curFlow.toFlowID,'to','cur')"
                    style="width:200px">
              <Option v-for="(item,idx) in flowList"
                      :value="item.value"
        ...
        <Form-item class="mgb10">
          <Row>
            ...
            <Select v-model="relFlowForm3.relatedFlow.fromFlowID"
                    @on-change = "getSksAndNodeByFlowId(relFlowForm3.relatedFlow.fromFlowID,'from','rel')"
                    style="width:220px">
              <Option v-for="(item,_idx) in flowList"
                      :value="item.value"
            ...
            <Select v-model="relFlowForm3.relatedFlow.toFlowID"
                    @on-change = "getSksAndNodeByFlowId(relFlowForm3.relatedFlow.toFlowID,'to','rel')"
                    style="width:220px">
              <Option v-for="(item,_idx) in flowList"
                      :value="item.value"
                      :key="item.value+_idx+3"
        ...
        >
          <Row>
            <Col span="7">
            <Select v-model="eachRelatedFlowsCondition.fromSkName" placement="top">
              <Option v-for="(item,_index) in relFlowForm3.relatedFlow.fromSkList" :value="item.value" :key="item.value+_index+3">
                {{ item.label }}
              </Option>
            </Select>
            </Col>
  ...
  export default{
                 ...
                 .then((response)=>{
                    if(response.data.conditions){
                        ...
                        if(_condition.condition[0] && _condition.condition[0].toflowid){
                            ...
                            this.curFlowForm.toNodeList = this.getNodesByFlowidReshow(_condition.condition[0].toflowid);
                            this.curFlowForm.toFlowID = _condition.condition[0].toflowid;
                            if(_condition.condition[0].tonodeid){
                              this.curFlowForm.tonodeid = _condition.condition[0].tonodeid;
                            }else{
                              this.curFlowForm.tonodeid = ''
                            }
                            if(_condition.condition[0].tonextnodeid){
                              this.curFlowForm.tonextnodeid = _condition.condition[0].tonextnodeid;
                            }else{
                              this.curFlowForm.tonextnodeid = ''
                            }
                            var _tempCurArr = []
                        ...
                        if(_ajaxRelCondition[0]){
                            if(_ajaxRelCondition[0].curflow){
                                ...
                                this.relFlowForm1.toNodeList = this.getNodesByFlowidReshow(_ajaxRelCondition[0].curflow.toflowid)
                                if(_ajaxRelCondition[0].tonodeid){
                                  this.relFlowForm1.tonodeid = _ajaxRelCondition[0].tonodeid
                                }else{
                                  this.relFlowForm1.tonodeid = ''
                                }

                                if(_ajaxRelCondition[0].tonextnodeid){
                                  this.relFlowForm1.tonextnodeid = _ajaxRelCondition[0].tonextnodeid
                                }else{
                                  this.relFlowForm1.tonextnodeid = ''
                                }
                                var _tempArr = [];
                            ...
                            if(_ajaxRelCondition[0].relatedflow){
                                this.relFlowForm1.relatedFlow.fromFlowID = _ajaxRelCondition[0].relatedflow.fromflowid;
                                this.relFlowForm1.relatedFlow.toFlowID = _ajaxRelCondition[0].relatedflow.toflowid;
                                this.relFlowForm1.relatedFlow.fromSkList = this.getSksByFLowidReshow(_ajaxRelCondition[0].relatedflow.fromflowid);
                        ...
                        if(_ajaxRelCondition[1]){
                            if(_ajaxRelCondition[1].curflow){
                                ...
                                this.relFlowForm2.toNodeList = this.getNodesByFlowidReshow(_ajaxRelCondition[1].curflow.toflowid)
                                if(_ajaxRelCondition[1].tonodeid){
                                  this.relFlowForm2.tonodeid = _ajaxRelCondition[1].tonodeid
                                }else{
                                  this.relFlowForm2.tonodeid = ''
                                }

                                if(_ajaxRelCondition[1].tonextnodeid){
                                  this.relFlowForm2.tonextnodeid = _ajaxRelCondition[1].tonextnodeid
                                }else{
                                  this.relFlowForm2.tonextnodeid = ''
                                }
                                var _tempArr = [];
                            ...
                            if(_ajaxRelCondition[1].relatedflow){
                                this.relFlowForm2.relatedFlow.fromFlowID = _ajaxRelCondition[1].relatedflow.fromflowid;
                                this.relFlowForm2.relatedFlow.toFlowID = _ajaxRelCondition[1].relatedflow.toflowid;
                                this.relFlowForm2.relatedFlow.fromSkList = this.getSksByFLowidReshow(_ajaxRelCondition[1].relatedflow.fromflowid);
                        ...
                        if(_ajaxRelCondition[2]){
                            if(_ajaxRelCondition[2].curflow){
                                ...
                                this.relFlowForm3.toNodeList = this.getNodesByFlowidReshow(_ajaxRelCondition[2].curflow.toflowid)
                                if(_ajaxRelCondition[2].tonodeid){
                                  this.relFlowForm3.tonodeid = _ajaxRelCondition[2].tonodeid
                                }else{
                                  this.relFlowForm3.tonodeid = ''
                                }

                                if(_ajaxRelCondition[2].tonextnodeid){
                                  this.relFlowForm3.tonextnodeid = _ajaxRelCondition[2].tonextnodeid
                                }else{
                                  this.relFlowForm3.tonextnodeid = ''
                                }
                                var _tempArr = [];
                            ...
                            if(_ajaxRelCondition[2].relatedflow){
                                this.relFlowForm3.relatedFlow.fromFlowID = _ajaxRelCondition[2].relatedflow.fromflowid;
                                this.relFlowForm3.relatedFlow.toFlowID = _ajaxRelCondition[2].relatedflow.toflowid;
                                this.relFlowForm3.relatedFlow.fromSkList = this.getSksByFLowidReshow(_ajaxRelCondition[2].relatedflow.fromflowid);
     ...
     methods:{
        ...
        getNodesByFlowidReshow(flowid){
            ...
            var _ajaxAllFlows = this.ajaxAllFlows;

            for(var c = 0;c<_ajaxAllFlows.length;c++){
              if(flowid == _ajaxAllFlows[c].id && _ajaxAllFlows[c].nodes.length &&  _ajaxAllFlows[c].nodes.length > 0){
                for(var d = 0;d < _ajaxAllFlows[c].nodes.length;d++){
                  var _tmpObj = {}
                  if(_ajaxAllFlows[c].nodes[d].nodeid){
                    _tmpObj.value =  _ajaxAllFlows[c].nodes[d].nodeid
                    _tmpObj.label = _ajaxAllFlows[c].nodes[d].name + "(" + _ajaxAllFlows[c].nodes[d].nodeid + ")"
                    _resNodeArr.push(_tmpObj)
                  }
                }
              }
            }

            if(_resNodeArr.length == 1){
              _resNodeArr = [{
                label:'此流程无节点',
                value:''
              }]
        ...
        getSksAndNodeByFlowId(flowid,where,which){
            // 找这个流程的sk部分
           var _arr = [{
              label:'空',
              value:''
            ...
            if(this.curIdx == -10){
              this.curFlowForm.toNodeList = _resNodeArr
              if(where == 'from'){
              ...
              this.relFlowForm1.toNodeList = _resNodeArr
              console.log(this.relFlowForm1.toNodeList)
              if(which == 'cur'){
                if(where == 'from'){
              ...
              this.relFlowForm2.toNodeList = _resNodeArr
              if(which == 'cur'){
                if(where == 'from'){
              ...
              this.relFlowForm3.toNodeList = _resNodeArr
              if(which == 'cur'){
                if(where == 'from'){
        ...
        endNodeConditionOk(){
            ...
            if(_curFlowObj['condition'] && _curFlowObj['condition'].length > 0){
                ...
                _curFlowObj['tonodeid'] = this.curFlowForm.tonodeid
                _curFlowObj['tonextnodeid'] = this.curFlowForm.tonextnodeid
            }
            // 相关流程1的条件
            var relFlow1Obj = {};
            ...
            if( (relFlow1Obj.relatedflow && relFlow1Obj.relatedflow.condition && relFlow1Obj.relatedflow.condition.length > 0)
                || (relFlow1Obj.curflow && relFlow1Obj.curflow.condition && relFlow1Obj.curflow.condition.length > 0) ){
                 relFlow1Obj.tonodeid = this.relFlowForm1.tonodeid
                  relFlow1Obj.tonextnodeid = this.relFlowForm1.tonextnodeid
            ...
            if( (relFlow2Obj.relatedflow && relFlow2Obj.relatedflow.condition.condition && relFlow2Obj.relatedflow.condition.length > 0)
                || (relFlow2Obj.curflow && relFlow2Obj.curflow.condition && relFlow2Obj.curflow.condition.length > 0) ){
                 relFlow2Obj.tonodeid = this.relFlowForm2.tonodeid
                 relFlow2Obj.tonextnodeid = this.relFlowForm2.tonextnodeid
            ...
            if( (relFlow3Obj.relatedflow && relFlow3Obj.relatedflow.condition.condition && relFlow3Obj.relatedflow.condition.length > 0)
                ...
                relFlow3Obj.tonodeid = this.relFlowForm3.tonodeid
                relFlow3Obj.tonextnodeid = this.relFlowForm3.tonextnodeid
